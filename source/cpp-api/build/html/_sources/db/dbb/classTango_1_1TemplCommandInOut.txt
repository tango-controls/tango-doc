...
members <../../df/d5d/classTango_1_1TemplCommandInOut-members.html>`__
...
(const char \*cmd\_name, OUTARG(DeviceImpl::\*exe\_method)(INARG))
...
`More... <#a09bbe5a98cff5425a5627af76435f309>`__

 

 

`TemplCommandInOut <../../db/dbb/classTango_1_1TemplCommandInOut.html#ae905b4db452b115ae3232d0a179deac7>`__
(string &cmd\_name, OUTARG(DeviceImpl::\*exe\_method)(INARG))
...
`TemplCommandInOut <../../db/dbb/classTango_1_1TemplCommandInOut.html>`__
object for a command with a name and an execution method.
`More... <#ae905b4db452b115ae3232d0a179deac7>`__

 

 

`TemplCommandInOut <../../db/dbb/classTango_1_1TemplCommandInOut.html#aec7f943e0412016b1c1063d3dde694f3>`__
(const char \*cmd\_name, OUTARG(DeviceImpl::\*exe\_method)(INARG),
bool(DeviceImpl::\*state\_method)(const CORBA::Any &))

 

| Constructs a newly allocated TemplCommandInout object for a command
with a name, an execution method and a command allowed method.
`More... <#aec7f943e0412016b1c1063d3dde694f3>`__

 

 

`TemplCommandInOut <../../db/dbb/classTango_1_1TemplCommandInOut.html#a2ba0d93006c6d776248f35dc26578b87>`__
(string &cmd\_name, OUTARG(DeviceImpl::\*exe\_method)(INARG),
bool(DeviceImpl::\*state\_method)(const CORBA::Any &))
...
allowed method. `More... <#a2ba0d93006c6d776248f35dc26578b87>`__

 

 

`TemplCommandInOut <../../db/dbb/classTango_1_1TemplCommandInOut.html#a418733bc08eed3cc3fc7ce4ae2d36321>`__
(const char \*cmd\_name, OUTARG(DeviceImpl::\*exe\_method)(INARG), const
...
`More... <#a418733bc08eed3cc3fc7ce4ae2d36321>`__

 

 

`TemplCommandInOut <../../db/dbb/classTango_1_1TemplCommandInOut.html#a7725331aba633cde2f26f23769896b5a>`__
(string &cmd\_name, OUTARG(DeviceImpl::\*exe\_method)(INARG), string
...
object for a command with a name, an execution method and a description
for the input and output command parameters.
`More... <#a7725331aba633cde2f26f23769896b5a>`__

 

 

`TemplCommandInOut <../../db/dbb/classTango_1_1TemplCommandInOut.html#ac0845cca0f7b4a47f194dbe8741eeb4b>`__
(const char \*cmd\_name, OUTARG(DeviceImpl::\*exe\_method)(INARG),
...
`More... <#ac0845cca0f7b4a47f194dbe8741eeb4b>`__

 

 

`TemplCommandInOut <../../db/dbb/classTango_1_1TemplCommandInOut.html#a1d8eb4c66b7840913cee742e2138f10c>`__
(string &cmd\_name, OUTARG(DeviceImpl::\*exe\_method)(INARG),
...
object for a command with a name, an execution method, a command allowed
method and a description for the input and output command parameters.
`More... <#a1d8eb4c66b7840913cee742e2138f10c>`__

 

 

`TemplCommandInOut <../../db/dbb/classTango_1_1TemplCommandInOut.html#a4cd8aa04392f1c2ef665cb5bdfa7bc86>`__
(const char \*cmd\_name, OUTARG(DeviceImpl::\*exe\_method)(INARG),
...
`TemplCommandInOut <../../db/dbb/classTango_1_1TemplCommandInOut.html>`__
object for a command with a name and an execution method.
`More... <#a4cd8aa04392f1c2ef665cb5bdfa7bc86>`__

 

 

`TemplCommandInOut <../../db/dbb/classTango_1_1TemplCommandInOut.html#a29ec8158c25feb319848a876783fdc79>`__
(string &cmd\_name, OUTARG(DeviceImpl::\*exe\_method)(INARG),
Tango::DispLevel level)
...
`TemplCommandInOut <../../db/dbb/classTango_1_1TemplCommandInOut.html>`__
object for a command with a name and an execution method.
`More... <#a29ec8158c25feb319848a876783fdc79>`__

 

 

`TemplCommandInOut <../../db/dbb/classTango_1_1TemplCommandInOut.html#add11fefa6ae6dfb7e374d22c54eaedf0>`__
(const char \*cmd\_name, OUTARG(DeviceImpl::\*exe\_method)(INARG),
...
| Constructs a newly allocated TemplCommandInout object for a command
with a name, an execution method and a command allowed method.
`More... <#add11fefa6ae6dfb7e374d22c54eaedf0>`__

 

 

`TemplCommandInOut <../../db/dbb/classTango_1_1TemplCommandInOut.html#a2854675abd8fdbbcc63676db498195a1>`__
(string &cmd\_name, OUTARG(DeviceImpl::\*exe\_method)(INARG),
bool(DeviceImpl::\*state\_method)(const CORBA::Any &), Tango::DispLevel
level)
...
`TemplCommandInOut <../../db/dbb/classTango_1_1TemplCommandInOut.html>`__
object for a command with a name, an execution method and a command
allowed method. `More... <#a2854675abd8fdbbcc63676db498195a1>`__

 

 

`TemplCommandInOut <../../db/dbb/classTango_1_1TemplCommandInOut.html#abc84ec88a117f481e3b0ed8a6d273cce>`__
(const char \*cmd\_name, OUTARG(DeviceImpl::\*exe\_method)(INARG), const
...
object for a command with a name, an execution method and a description
for the input and output command parameters.
`More... <#abc84ec88a117f481e3b0ed8a6d273cce>`__

 

 

`TemplCommandInOut <../../db/dbb/classTango_1_1TemplCommandInOut.html#a0dd98b34ed11a4405f134969cf120152>`__
(string &cmd\_name, OUTARG(DeviceImpl::\*exe\_method)(INARG), string
...
object for a command with a name, an execution method and a description
for the input and output command parameters.
`More... <#a0dd98b34ed11a4405f134969cf120152>`__

 

 

`TemplCommandInOut <../../db/dbb/classTango_1_1TemplCommandInOut.html#aaf2cfe422127533782d5e8b4073548e3>`__
(const char \*cmd\_name, OUTARG(DeviceImpl::\*exe\_method)(INARG),
bool(DeviceImpl::\*state\_method)(const CORBA::Any &), const char
...
object for a command with a name, an execution method, a command allowed
method and a description for the input and output command parameters.
`More... <#aaf2cfe422127533782d5e8b4073548e3>`__

 

 

`TemplCommandInOut <../../db/dbb/classTango_1_1TemplCommandInOut.html#a145be9fc116c50ae461f5b6a038e3483>`__
(string &cmd\_name, OUTARG(DeviceImpl::\*exe\_method)(INARG),
bool(DeviceImpl::\*state\_method)(const CORBA::Any &), string &in\_desc,
...
object for a command with a name, an execution method, a command allowed
method and a description for the input and output command parameters.
`More... <#a145be9fc116c50ae461f5b6a038e3483>`__
...
`More... <#a9d173fb2b7578838e94f9a94d6d98757>`__
...
`More... <#ac5639e9122031a8e57887ff3411bb482>`__
...
The class template parameters (called INARG and OUTARG) are the command
input parameter type and the command output parameter type.

Synopsis : template <typename INARG,typename OUTARG> class
...
Usage : new
`TemplCommandInOut<Tango::DevLong,Tango::DevFloat> <../../db/dbb/classTango_1_1TemplCommandInOut.html#a09bbe5a98cff5425a5627af76435f309>`__\ (...);
...
+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+-----+----------------------------------+------------------+
| `Tango::TemplCommandInOut <../../db/dbb/classTango_1_1TemplCommandInOut.html>`__\ < INARG, OUTARG >::\ `TemplCommandInOut <../../db/dbb/classTango_1_1TemplCommandInOut.html>`__   | (   | const char \*                    | *cmd\_name*,     |
+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+-----+----------------------------------+------------------+
|                                                                                                                                                                                    |     | OUTARG(DeviceImpl::\*)(INARG)    | *exe\_method*    |
+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+-----+----------------------------------+------------------+
|                                                                                                                                                                                    | )   |                                  |                  |
+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+-----+----------------------------------+------------------+
...
+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+-----+----------------------------------+------------------+
| `Tango::TemplCommandInOut <../../db/dbb/classTango_1_1TemplCommandInOut.html>`__\ < INARG, OUTARG >::\ `TemplCommandInOut <../../db/dbb/classTango_1_1TemplCommandInOut.html>`__   | (   | string &                         | *cmd\_name*,     |
+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+-----+----------------------------------+------------------+
|                                                                                                                                                                                    |     | OUTARG(DeviceImpl::\*)(INARG)    | *exe\_method*    |
+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+-----+----------------------------------+------------------+
|                                                                                                                                                                                    | )   |                                  |                  |
...
a name, an execution method and a command allowed method.
...
| ------------------------------------ |                                      |
| --+-----+----+-----+----+            |                                      |
| | `Tango::TemplCommandInOut <../../d |                                      |
| b/dbb/classTango_1_1TemplCommandInOu |                                      |
| t.html>`__\ < INARG, OUTARG >::~\ `T |                                      |
| emplCommandInOut <../../db/dbb/class |                                      |
| Tango_1_1TemplCommandInOut.html>`__  |                                      |
|   | (   |    | )   |    |            |                                      |
| +----------------------------------- |                                      |
| ------------------------------------ |                                      |
| ------------------------------------ |                                      |
...
| InOut <../../db/dbb/classTango_1_1Te |                                      |
| mplCommandInOut.html>`__\ < INARG, O |                                      |
| UTARG >::execute   | (   | `DeviceIm |                                      |
| pl <../../d3/d62/classTango_1_1Devic |                                      |
| eImpl.html>`__ \*    | *dev*,        |                                      |
| |                                    |                                      |
| +----------------------------------- |                                      |
| ------------------------------------ |                                      |
...
associated command is requested by a client. It first unpacks the
incoming data. Then, it invokes the user supplied command execution
method and packs the returned data into the outgoing CORBA Any object
...
| --------------+-----+----+-----+---- |                                      |
| +                                    |                                      |
| | void `Tango::TemplCommandInOut <.. |                                      |
| /../db/dbb/classTango_1_1TemplComman |                                      |
| dInOut.html>`__\ < INARG, OUTARG >:: |                                      |
| init\_types   | (   |    | )   |     |                                      |
| |                                    |                                      |
| +----------------------------------- |                                      |
| ------------------------------------ |                                      |
...
Referenced by `Tango::TemplCommandInOut< INARG, OUTARG
>::TemplCommandInOut() <../../db/dbb/classTango_1_1TemplCommandInOut.html#a09bbe5a98cff5425a5627af76435f309>`__.
...
.. |Logo| image:: ../../logo.jpg
.. |Inheritance graph| image:: ../../db/daf/classTango_1_1TemplCommandInOut__inherit__graph.png
.. |Collaboration graph| image:: ../../d0/dc1/classTango_1_1TemplCommandInOut__coll__graph.png
.. |-| image:: ../../closed.png
