...
\subsection{The device polling}
\label{sub:The-device-polling-prop}
...
\subsubsection{The attribute display level\index{level} parameter}
\label{display level}
...
\section{Tango log consumer\index{consumer} }
...
MYSQL\_HOST and MYSQL\_DATABASE)}
\label{sub:Db-Env-Variables}
