...
This documentation\index{documentation} URL\index{URL} is the same
...
\section{The Tango Logging\index{logging} Service \label{The-Tango-Logging chapter}}
...
as static} and the Attribute\index{Attribute} object will not free this memory.
