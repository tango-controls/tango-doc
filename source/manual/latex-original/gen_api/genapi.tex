...
\subsection{Reading attribute(s)\index{attribute}\label{subsec:Read-attr} }
...
\subsubsection{Obtaining attribute values\label{subsec:O-attr-values}}
...
\subsubsection{Obtaining acknowledgement\label{subsec:O-ack}}
...
\subsubsection{Case 1: one value for all devices\label{subsec:Case-1-writing} }
